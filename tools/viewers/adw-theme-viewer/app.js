...
const MANIFEST_PATH = "tools/viewers/manifests/themes/adw.json";
...
const app = new Adw.Application({
	application_id: "io.venner.viewer.adw.theme",
...
function getThemeName() {
	...
	try {
		const v = settings.get_property("gtk-theme-name");
...
function handleCommand(line) {
	...
	switch (method) {
		case "ping":
			emit("ready", { viewerId: "adw-theme-viewer", tech: "adw", kind: "theme" });
			break;
