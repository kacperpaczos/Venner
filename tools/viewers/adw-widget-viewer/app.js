...
import { buildButtonScene } from "../../gtk-reference/libadwaita-gjs/widgets/button.js";
import { buildContainersScene } from "../../gtk-reference/libadwaita-gjs/widgets/containers.js";
import { buildControlsScene } from "../../gtk-reference/libadwaita-gjs/widgets/controls.js";
import { buildDisplayScene } from "../../gtk-reference/libadwaita-gjs/widgets/display.js";
import { buildEntryScene } from "../../gtk-reference/libadwaita-gjs/widgets/entry.js";
import { buildIndicatorsScene } from "../../gtk-reference/libadwaita-gjs/widgets/indicators.js";
import { buildInputExtraScene } from "../../gtk-reference/libadwaita-gjs/widgets/input-extra.js";
import { buildLayoutScene } from "../../gtk-reference/libadwaita-gjs/widgets/layout.js";
import { buildListScene } from "../../gtk-reference/libadwaita-gjs/widgets/list.js";
import { buildMediaScene } from "../../gtk-reference/libadwaita-gjs/widgets/media.js";
import { buildMediaControlsScene } from "../../gtk-reference/libadwaita-gjs/widgets/media-controls.js";
import { buildSwitchScene } from "../../gtk-reference/libadwaita-gjs/widgets/switch.js";
import { buildTabsScene } from "../../gtk-reference/libadwaita-gjs/widgets/tabs.js";
import { buildWindowingScene } from "../../gtk-reference/libadwaita-gjs/widgets/windowing.js";
...
const app = new Adw.Application({
	application_id: "io.venner.viewer.adw.widgets",
...
function handleCommand(line) {
	...
	switch (method) {
		case "ping":
			emit("ready", { viewerId: "adw-widget-viewer", tech: "adw", kind: "widget" });
			break;
