...
const MANIFEST_PATH = "tools/viewers/manifests/themes/gtk4.json";
...
const app = new Gtk.Application({
	application_id: "io.venner.viewer.gtk4.theme",
...
function handleCommand(line) {
	...
	switch (method) {
		case "ping":
			emit("ready", { viewerId: "gtk4-theme-viewer", tech: "gtk4", kind: "theme" });
			break;
